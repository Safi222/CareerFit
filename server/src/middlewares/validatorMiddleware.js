...
/**
 * @returns {Array} - An array of validation checks for the register form including first name, last name, email, and password.
 */
...
/**
 * @returns {Array} - An array of validation checks for the login form including email and password.
 */
