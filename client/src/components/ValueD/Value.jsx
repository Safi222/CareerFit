...
const Value = () => {
  return (
    <div className='mb-[4rem] mt-[]6rem'>
      <h1 className='text-textColor text-[25px] py-[2rem] pb-[3rem] font-bold w-[400px] block'>The value that holds us true to account</h1>
    ...
    font-semibold text-black hover:bg-orangColor border-orangeColor'>
    Get started
    </button>
    </div>
    </div>
