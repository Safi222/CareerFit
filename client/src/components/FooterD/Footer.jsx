...
const Footer = () => {
  return (
    <>
      <div className="footer p-8 mb-4 bg-orangeColor  grid grid-cols-1 md:grid-cols-5 gap-8 m-auto items-center justify-center">
      ...
      <footer className="p-3 text-center text-gray-500">
